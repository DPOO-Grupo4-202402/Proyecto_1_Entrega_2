...
public class IniciarSesionProfesorCalificador extends JFrame{
	...
	public IniciarSesionProfesorCalificador() {
		
		setTitle("Iniciar Sesion como Profesor Calificador");
		setSize(400, 300);
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		setLocationRelativeTo(null);
		setLayout(new BorderLayout(10, 10));
		
		lblTitulo = new JLabel("Inicio de Sesion para Profesores Calificadores", SwingConstants.CENTER);
	...
	public static void main(String[] args) {
		...
		new IniciarSesionProfesorCalificador();
	}
